...
export default function App() {
  ...
  //Filter out the movie we no longer want in our list. If the id of the movie is not equal to the id of the movie we want to delete, keep it in the list
...
//Reusable component for left and right display boxes
function Box({ children }) {
  ...
  return (
    ...
    <div className="box">
      {/*Button to toggle the display of movie results*/}
...
//Components for displaying watched list on right side
// function WatchedBox() {
            ...
            <div className="rating">
              {!isWatched ? (
                <>
                  ...
                  />
                  {/* Only show add movie button if the user gives a rating */}
                  {userRating > 0 && (
